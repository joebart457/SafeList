...
namespace IpSafeList.Services
{
    ...
    public static class LoggerService
    {
        ...
        public static void Log<Ty>(List<Ty> ls, bool force = false)
        {
            Log(ls, new List<string>(), force);
        }
        public static void Log<Ty>(List<Ty> ls, List<string> excludeFields, bool force = false)
        {
            if (LoggingEnabled || force)
            {
